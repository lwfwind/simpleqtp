...
''' oDBLib.Init "a106403", "QWERTY5", "SFB.PP"

''' sqlQuery = "select * from SFB.DIM_PRODUCT"

''' ------Export DB query result to 2D Array ---------------------
''' Call oDBLib.ExportDBTo2DArray(sqlQuery, Array_2D)
''' MsgBox Ubound(Array_2D, 1)
''' MsgBox Ubound(Array_2D, 2)
''' MsgBox Array_2D(3,3)

''' ------Export DB query result to excel sheet ------------------
''' oDBLib.ExportDBToExcel "C:\test.xlsx", sqlQuery
''' </example>
''' #########################################################
...
Class ClsDBLib
	...
	Public Function ExportDBTo2DArray(ByVal sqlQuery, ByRef Array_2D)
	...
	Public Function ExportDBToExcel(ByVal sWorkbook, ByVal sqlQuery)
		...
		CreateNewWorkBook sWorkbook, true
    ...
    ''' <param name="bReplaceOldFile" type="bool">determine replace old file or not</param>   
    ''' <remarks></remarks>
